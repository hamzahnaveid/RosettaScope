...
class GradingRepository {
    ...
    suspend fun gradeSpeech(refText: String, targetLanguage: String, recordingAudioBytes: String) : GradingResponse {
        return RetrofitInstance.api.gradeSpeech(
            GradingRequest(refText, targetLanguage, recordingAudioBytes)
        )
    }
}